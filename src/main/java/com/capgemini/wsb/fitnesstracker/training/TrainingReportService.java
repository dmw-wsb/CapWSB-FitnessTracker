...
public class TrainingReportService {
    ...
    public void generateAndSendMonthlyReports() {
        ...
        for (UserDto user : users) {
            ...
            String report = String.format("Świetna robota! W tym miesiącu masz na swoim koncie %d treningów.", trainingCount);

            emailService.sendEmail(user.email(), "Twoje treningi w tym miesiącu: podsumowanie.", report);
        }
    }
}